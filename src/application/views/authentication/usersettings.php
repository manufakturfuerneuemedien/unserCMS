<html>
    ...
    <body>
    	<div id="settings_container">
    		<h1>User settings</h1>
    		<form id="settings_form" action="<?= site_url('authentication/updateUserdata')?>" method="post">
    			...
    			<table>
    				<tbody>
    					...
    					<tr>
    						<td colspan="2"><a href="<?= site_url('backend')?>"><div id="backbutton"/>Return to FRINK Academy</a></td>
    					</tr>
    				</tbody>
    			</table>
    		</form>
