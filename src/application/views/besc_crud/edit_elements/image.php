...
<div class="bc_column <?php if(($num_row) %2 == 0): ?>erow<?php endif;?>" col_name="<?= $db_name?>">
    ...
    <?php endif; ?>
	<div class="bc_column_input bc_col_image" <?php if($js_callback_after_upload != ""):?> callback_after_upload="<?=$js_callback_after_upload?>"<?php endif;?>>
	<?php if(!isset($value) || $value == ""): ?>
		...
		<input type="button" class="bc_col_image_upload_btn" value="Upload" /> 
